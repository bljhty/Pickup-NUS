/// Widget box listing the restaurant information that is pending approval
/// based on the restaurantId obtained in admin_home_page.dart
///
/// @param restaurantId Id of restaurant that requires approval from admin
/// @return widget box of restaurant information
...
class _ApprovalBoxState extends State<ApprovalBox> {
  ...
  /// Obtains from database the information of the restaurant
  /// and updates into restaurant variable
